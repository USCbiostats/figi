...
wdir <- "~/Dropbox/code/FIGI_PostHarmonization/Folate/working/"
source("~/Dropbox/code/FIGI_PostHarmonization/Folate/FIGI_PostHarmonization_Folate_functions.R")
...
table(gxe_set$studyname, gxe_set$folate_totqc2)

#------------------------------------------------------#
## There are 48 studies with folate info available
## (based on folate_totqc2)
