...
# this newest sample file cleans up some sample issues we identified previously
#
#
#
...
library("data.table")
rm(list = ls())
setwd('~/data/FIGI_samplefile_epi-190313/')
...
# all but oncoarray_to_usc for now
wrapp <- function(x) {
...
# only 3 vcf samples missing from samplefile (ccfr_omni, already knew about this):
