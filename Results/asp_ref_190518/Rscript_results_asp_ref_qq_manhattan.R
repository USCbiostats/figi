...
write.table(results_G_EasyStrata, file = "/media/work/tmp/EasyStrata_MarginalG_asp_ref_sex_age_pc_studygxe_N72820.txt", quote = F, row.names = F, sep = '\t')

EasyStrata("figures/EasyStrata_MarginalG_asp_ref_sex_age_pc_studygxe_N72820.ecf")
...
write.table(results_GxE_EasyStrata, file = "/media/work/tmp/EasyStrata_GxE_asp_ref_sex_age_pc_studygxe_N72820.txt", quote = F, row.names = F, sep = '\t')

EasyStrata("figures/EasyStrata_GxE_asp_ref_sex_age_pc_studygxe_N72820.ecf")
...
x <- filter(results_GxE, P < 5e-8)
write.table(x, file = "~/FIGI_GxNSAIDs_Sig_Results.txt", quote = F, row.names = F, sep = '\t')
...
#--------------------------------------------------------#
results_2df <- gxe %>%
  mutate(P = pchisq(chiSq2df, df = 2, lower.tail = F)) %>%
...
write.table(results_2df_EasyStrata, file = "/media/work/tmp/EasyStrata_2df_asp_ref_sex_age_pc_studygxe_N72820.txt", quote = F, row.names = F, sep = '\t')

EasyStrata("figures/EasyStrata_2df_asp_ref_sex_age_pc_studygxe_N72820.ecf")
