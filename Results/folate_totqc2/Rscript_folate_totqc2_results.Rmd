---
title: "FIGI Analysis - folate_totqc2"
...
#-----------------------------------------------------#
# Define Exposure Variable HERE
# manually edit meta-analysis covariates (fix soon)
#-----------------------------------------------------#
results_exposure <- "folate_totqc2"
```
...
# keep it minimal: 
# - filter drop/gxe
# - only fix outcome, E (numeric), covariates (numeric), and 'colo2&3' study_gxe name
#
...
pdat <- dat %>%
  dplyr::mutate(!!results_exposure := fct_rev(factor(!! sym(results_exposure), exclude = NULL, levels = c(1,2,3,4,NA))))

ggplot(data=pdat, aes(x=outcome)) +
    geom_bar(aes(fill = !! sym(results_exposure)), position = 'fill') +
    theme_bw() +
    theme(
...
varlist <- c("age_ref_imp", "sex", "education", "smoke", "bmi", "famhx1", results_exposure, "calcium_tot", "fruit", "vegetable", "redmeat", "procmeat")
varlistCat <- c("sex", "education", "smoke", "famhx1", results_exposure)
create_descriptive_table(dat, outcome, !! sym(results_exposure), varlist, varlistCat)
```
<br><br><br>

### cancer_site_sum1 = 'colon'
```{r, echo = F, message = F, cache = F}
create_descriptive_table(dat %>% dplyr::filter(cancer_site_sum1 == "colon" | outcome == 0), outcome, !! sym(results_exposure), varlist, varlistCat)
```
<br><br><br>

### cancer_site_sum1 = 'rectal'
```{r, echo = F, message = F, cache = F}
create_descriptive_table(dat %>% dplyr::filter(cancer_site_sum1 == "rectal" | outcome == 0), outcome, !! sym(results_exposure), varlist, varlistCat)
```
<br><br><br>
...
```{r, echo = F, message = F, cache = F}
#
# Important to edit this accordingly 
# 
meta_function_wrap <- function(dat) {
  study_info <- readRDS("~/data/Annotations/FIGI_studygxe_info.rds")
  gxe_counts <- get_counts_outcome_by_group(dat, outcome, !! sym(results_exposure), study_gxe)
  gxe_glm <- get_estimates_e_by_group(dat, outcome = outcome, exposure = !! sym(results_exposure), group = study_gxe, age_ref_imp, sex, energytot)
  gxe_meta <- dplyr::inner_join(gxe_counts, gxe_glm, 'study_gxe') %>%
...
gxe_meta <- meta_function_wrap(dat)
...
gxe_meta <- meta_function_wrap(tmp)
...
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
knitr::include_graphics("figures/EasyStrata_folate_totqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGxE
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
knitr::include_graphics("figures/EasyStrata_folate_totqc2_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
knitr::include_graphics("figures/EasyStrata_folate_totqc2_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 3DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
knitr::include_graphics("figures/EasyStrata_folate_totqc2_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGE (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
...
### chiSqControl (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSqControl_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### chiSqCase
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_totqc2_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
knitr::include_graphics("figures/EasyStrata_folate_totqc2_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqG)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_totqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_totqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqEDGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_totqc2_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_totqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_totqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_totqc2_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_54084.png")
```
<br><br><br>
---------------
