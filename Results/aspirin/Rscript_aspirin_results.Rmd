...
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
knitr::include_graphics("figures/EasyStrata_aspirin_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGxE
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
knitr::include_graphics("figures/EasyStrata_aspirin_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
knitr::include_graphics("figures/EasyStrata_aspirin_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 3DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
knitr::include_graphics("figures/EasyStrata_aspirin_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGE (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
```
...
### chiSqControl (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSqControl_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### chiSqCase
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_aspirin_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
knitr::include_graphics("figures/EasyStrata_aspirin_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqG)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqEDGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485_LDclump.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485_LDclump.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_aspirin_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_N_66485_LDclump.png")
```
<br><br><br>
---------------
...
posthoc_df <- do.call(inner_join, lapply(list.files("~/data/Results/aspirin/dosage/", pattern = "GetSNPValues_aspirin_sex_age_pc3_studygxe_index_positions_chr", full.names = T), function(x) data.frame(readRDS(x)) %>% rownames_to_column("vcfid"))) %>% 
