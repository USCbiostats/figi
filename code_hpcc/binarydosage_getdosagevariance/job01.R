...
out <- GetAlternateAlleleFrequenciesCrap(figiGene, 1L:nrow(figiGene[[11]]), samples)
saveRDS(out, file = paste0("/staging/dvc/andreeki/AAF/FIGI_DosageVariance_chr", chr, ".rds"))
