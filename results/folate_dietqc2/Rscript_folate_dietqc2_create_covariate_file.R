...
cov_gxescan <- dplyr::select(cov_gxescan, -Kentucky, -study_gxe, -folate_dietqc2, folate_dietqc2)

# save files
saveRDS(cov,         file = '~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_52447_GLM.rds', version = 2)
saveRDS(cov_gxescan, file = "~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_52447.rds",     version = 2)
...
# save files
saveRDS(cov,         file = '~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_colon_47176_GLM.rds', version = 2)
saveRDS(cov_gxescan, file = "~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_colon_47176.rds",     version = 2)
...
# save files
saveRDS(cov,         file = '~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_rectum_37281_GLM.rds', version = 2)
saveRDS(cov_gxescan, file = "~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_folate_dietqc2_sex_age_pc3_energytot_studygxe_rectum_37281.rds",     version = 2)
