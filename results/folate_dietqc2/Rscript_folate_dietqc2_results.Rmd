...
#-----------------------------------------------------#
results_exposure <- "folate_dietqc2"
```
...
meta_function_wrap <- function(dat) {
  ...
  gxe_glm <- get_estimates_e_by_group(dat, outcome, !! sym(results_exposure), group=study_gxe, age_ref_imp, sex, energytot)
...
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
knitr::include_graphics("figures/EasyStrata_folate_dietqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGxE
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
knitr::include_graphics("figures/EasyStrata_folate_dietqc2_chiSqGxE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
knitr::include_graphics("figures/EasyStrata_folate_dietqc2_chiSq2df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 3DF
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
knitr::include_graphics("figures/EasyStrata_folate_dietqc2_chiSq3df_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### chiSqGE (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
...
### chiSqControl (QQ)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSqControl_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### chiSqCase
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/QQ_Plot_folate_dietqc2_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
knitr::include_graphics("figures/EasyStrata_folate_dietqc2_chiSqCase_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.txt.mh.png")
```
<br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqG)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_dietqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_dietqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
### 2-Step (chiSqEDGE)
```{r , echo=FALSE,  out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_folate_dietqc2_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
---------------------------------------------------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_dietqc2_chiSqG_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_dietqc2_chiSqGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br>
---------------
...
```{r , echo=FALSE, out.width = '100%'}
knitr::include_graphics("figures/TwoStep_WeightedHypothesis_gxe_twostep_ld_folate_dietqc2_chiSqEDGE_age_ref_imp_sex_study_gxe_PC1_PC2_PC3_energytot_N_52447.png")
```
<br><br><br>
---------------
