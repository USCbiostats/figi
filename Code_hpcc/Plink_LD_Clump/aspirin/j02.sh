...
#SBATCH --array=1-22
#SBATCH --output=../logs/Plink_aspirin_ldclump_chiSqG_chr%a.log
...
plink \
    ...
    --memory 8000 \
    --clump ${OUT}/Plink_aspirin_ldclump_chiSqG_chr${SLURM_ARRAY_TASK_ID}.txt \
    --clump-p1 1 --clump-p2 1 \
    --out   ${OUT}/Plink_aspirin_ldclump_chiSqG_chr${SLURM_ARRAY_TASK_ID}
