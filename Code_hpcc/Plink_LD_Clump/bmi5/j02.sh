...
#SBATCH --array=1-22
#SBATCH --output=../logs/Plink_bmi5_ldclump_chiSqGxE_chr%a.log

INN=/auto/pmd-01/andreeki/clump
INN=/staging/dvc/andreeki/clump
OUT=/staging/dvc/andreeki/clump_results/bmi5
...
plink \
    ...
    --memory 8000 \
    --clump ${OUT}/Plink_bmi5_ldclump_chiSqGxE_chr${SLURM_ARRAY_TASK_ID}.txt \
    --clump-p1 1 --clump-p2 1 \
    --out   ${OUT}/Plink_bmi5_ldclump_chiSqGxE_chr${SLURM_ARRAY_TASK_ID}
