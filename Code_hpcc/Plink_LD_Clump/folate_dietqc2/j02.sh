...
OUT=/staging/dvc/andreeki/clump_results/folate_dietqc2
...
plink \
    ...
    --memory 8000 \
    --clump ${OUT}/Plink_folate_dietqc2_ldclump_chiSqGxE_chr${SLURM_ARRAY_TASK_ID}.txt \
    --clump-p1 1 --clump-p2 1 \
    --out   ${OUT}/Plink_folate_dietqc2_ldclump_chiSqGxE_chr${SLURM_ARRAY_TASK_ID}
