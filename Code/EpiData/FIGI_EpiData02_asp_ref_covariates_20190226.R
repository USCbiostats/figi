...
load("~/data/FIGI_EpiData_rdata/FIGI_Genotype_Epi_20190313.RData")


#------ GxE Set - asp_ref (N = 102,792 --> 72,145) ------
pc30k <- fread("~/data/PrincipalComponents/FIGI_GxESet.eigenvec", skip = 1, 
...
# ----- save, no dummy var ------
saveRDS(cov, file = "~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_asp_ref_sex_age_pc10_studygxe_72145_GLM.rds")
...
# ------ save, WITH dummy var ------
saveRDS(cov, file = '~/data/GxEScanR_PhenotypeFiles/FIGI_GxESet_asp_ref_sex_age_pc10_studygxe_72814.rds')
