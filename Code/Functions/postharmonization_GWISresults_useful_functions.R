#=============================================================================#
# Useful Functions (source in script)
#=============================================================================#


#-----------------------------------------------------------------------------#
# count case/control by exposure levels for each study/platform
# also calculate totals for all studies combined
# output a data.frame
getCounts <- function(data, group, exposure, outcome) {
	...
	castFormula = as.formula(paste0(quo_name(group_quo), "~", quo_name(outcome_quo), "+", quo_name(exposure_quo)))
...
#-----------------------------------------------------------------------------#
# Create bar plots for exposure variables
# save ggplot objects as rds 
# you know, you should make sure the data is in the right format... 
